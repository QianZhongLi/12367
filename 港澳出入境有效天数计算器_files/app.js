  ...
  function bindEvents() {
    ...
    if (demoBtn) {
      demoBtn.addEventListener('click', () => {
        stopAutoDemo();
        const dates = ['05-28','05-27','05-27','05-27','05-26','05-26','05-26','05-26','05-25','05-25','05-24','05-24','05-23','05-23','05-22','05-22','05-21','05-21','05-21','05-21','05-19','05-19','05-18','05-17','05-16','05-16','05-15'];
        const demoText = `国家移民管理局 出入境记录查询结果（电子文件）
查询人姓名: **，性别: 男，出生日期: ***********，公民身份号码: ******************，通过国家移民管理局出入境记录查询系统查询，
其本人在2025年05月29日至2026年05月29日期间有下列出入境记录：
编号：************* 查询日期：2026年05月29日
序号 出境/入境 出入境日期 证件名称 证件号码 出入境口岸
航班号 ` + dates.map((date, index) => `${index + 1} ${index % 2 === 0 ? '出境' : '入境'} 2026-${date} 往来港澳通行证 ********* 横琴口岸`).join('\n');
  ...
  function showResultModal() {
    ...
    if (modalTitle) modalTitle.textContent = state.isDemo ? '此为示例数据测试' : `${regionName}计算结果`;
